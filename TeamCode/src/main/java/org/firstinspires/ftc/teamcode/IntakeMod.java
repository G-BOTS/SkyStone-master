...
//        robot.horiElv.setTargetPosition(-4320);//negative target is going out, positive is going in
//        robot.horiElv.setMode(DcMotor.RunMode.RUN_TO_POSITION);
//        robot.horiElv.setPower(0.3);//positive is moving in
//        robot.horiElv.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
...
//        HorzontalElevator(0.3, 800);
        robot.left_hand.setPosition(0.31);
        robot.right_hand.setPosition(0.69);
        encoderDrive(DRIVE_SPEED,   24, 24, 5.0);  // S1:  24 Drive forward 4 Sec timeout
        encoderDrive(0.3,   6, 6, 5.0);  // S1:  24 Drive forward 4 Sec timeout
...
//        sleep(4000);
        ...
        encoderDrive(DRIVE_SPEED,-53,-53,4);
